...
cargo install boatramp@0.4.12 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.12 -- serve  # pin a release
...
```sh
git checkout v0.4.12                                                # the release (omit for the development tip)
