...
cargo install boatramp@0.3.13 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.3.13 -- serve  # pin a release
...
```sh
git checkout v0.3.13                                                # the release (omit for the development tip)
