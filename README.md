...
cargo install boatramp@0.4.20 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.20 -- serve  # pin a release
...
```sh
git checkout v0.4.20                                                # the release (omit for the development tip)
