...
cargo install boatramp@0.5.2 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.5.2 -- serve  # pin a release
...
```sh
git checkout v0.5.2                                                 # the release (omit for the development tip)
