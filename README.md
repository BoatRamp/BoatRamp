...
cargo install boatramp@0.5.4 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.5.4 -- serve  # pin a release
...
```sh
git checkout v0.5.4                                                 # the release (omit for the development tip)
