...
cargo install boatramp@0.3.11 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.3.11 -- serve  # pin a release
...
```sh
git checkout v0.3.11                                                # the release (omit for the development tip)
