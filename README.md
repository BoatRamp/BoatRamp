...
cargo install boatramp@0.4.15 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.15 -- serve  # pin a release
...
```sh
git checkout v0.4.15                                                # the release (omit for the development tip)
