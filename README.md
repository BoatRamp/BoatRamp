...
cargo install boatramp@0.4.0 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.0 -- serve  # pin a release
...
```sh
git checkout v0.4.0                                                # the release (omit for the development tip)
