...
cargo install boatramp@0.4.23 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.23 -- serve  # pin a release
...
```sh
git checkout v0.4.23                                                # the release (omit for the development tip)
