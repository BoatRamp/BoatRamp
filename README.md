...
cargo install boatramp@0.4.21 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.21 -- serve  # pin a release
...
```sh
git checkout v0.4.21                                                # the release (omit for the development tip)
