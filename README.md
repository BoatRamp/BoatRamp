...
cargo install boatramp@0.4.22 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.22 -- serve  # pin a release
...
```sh
git checkout v0.4.22                                                # the release (omit for the development tip)
