...
cargo install boatramp@0.5.7 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.5.7 -- serve  # pin a release
...
```sh
git checkout v0.5.7                                                 # the release (omit for the development tip)
