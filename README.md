...
cargo install boatramp@0.3.16 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.3.16 -- serve  # pin a release
...
```sh
git checkout v0.3.16                                                # the release (omit for the development tip)
