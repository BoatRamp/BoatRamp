...
cargo install boatramp@0.4.26 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.26 -- serve  # pin a release
...
```sh
git checkout v0.4.26                                                # the release (omit for the development tip)
