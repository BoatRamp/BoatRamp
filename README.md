...
cargo install boatramp@0.4.6 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.6 -- serve  # pin a release
...
```sh
git checkout v0.4.6                                                # the release (omit for the development tip)
