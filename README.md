...
cargo install boatramp@0.3.19 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.3.19 -- serve  # pin a release
...
```sh
git checkout v0.3.19                                                # the release (omit for the development tip)
