...
cargo install boatramp@0.4.2 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.2 -- serve  # pin a release
...
```sh
git checkout v0.4.2                                                # the release (omit for the development tip)
