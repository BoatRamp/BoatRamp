...
cargo install boatramp@0.3.8 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.3.8 -- serve  # pin a release
...
```sh
git checkout v0.3.8                                                # the release (omit for the development tip)
