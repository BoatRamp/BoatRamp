...
cargo install boatramp@0.4.11 --locked     # pin a version
```
...
nix run github:BoatRamp/BoatRamp/v0.4.11 -- serve  # pin a release
...
```sh
git checkout v0.4.11                                                # the release (omit for the development tip)
