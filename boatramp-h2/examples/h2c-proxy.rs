...
//! socket (M4a: userspace streaming; M4b: kernel splice + kTLS). For correctness
//! testing:  cargo run --example h2c-proxy   then curl --http2-prior-knowledge.
use boatramp_h2::{serve_connection_tcp, Body, Handler, Request, Response};
