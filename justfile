...
build-fixtures:
    ...
    for name in http-200 kv-counter sql-counter event-consumer invoke-caller graphql-accounts graphql-reviews graphql-agent; do
      echo "== building $name =="
...
crate_order := "boatramp-types boatramp-rpktls boatramp-acme boatramp-core boatramp-storage boatramp-cloudflare boatramp-container boatramp-docker boatramp-firecracker boatramp-vz boatramp-mcp boatramp-cluster boatramp-handlers boatramp-server boatramp-node boatramp"
